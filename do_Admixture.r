...
barplot(t(as.matrix(snpk4)),
        ...
        border=NA, main="K=4", cex.names=0.7, las=2,
        ylab="ancestry")
barplot(t(as.matrix(snpk5)),
        col= c("lightgreen","Dark red","lightblue","yellow","pink"),
        border=NA, main="K=5", cex.names=0.7, las=2,
        ylab="ancestry")
